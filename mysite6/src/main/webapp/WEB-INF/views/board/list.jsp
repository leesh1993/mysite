						...
						<tr>
							...
							<c:choose>
								...
								<c:when test="${vo.state eq 'u'}">
									<c:if test="${vo.o_no > 1 }">
										<td style='padding-left:${50*vo.depth}px'><img src='${pageContext.servletContext.contextPath }/assets/images/reply.png'><a href="${pageContext.servletContext.contextPath }/board/view/${vo.no }/${vo.user_no}/${cCount }">[수정] ${vo.title }</a></td>
									</c:if>
									<c:if test="${vo.o_no eq 1 }">
										<td><a
